...
| Scenario | 狀態 | 對應實作 | 備註 |
|---|---|---|---|
| 成功載入主題分類 | ✅ 已實作 | `EtfThemeViewModel.kt:42` | |
| Remote Config 為空 | ✅ 已實作 | `EtfThemeViewModel.kt:58` | |
| 網路異常 | ⚠️ 部分實作 | `EtfThemeViewModel.kt:65` | 缺少離線提示 |
...
| Scenario | 狀態 | 對應實作 | 備註 |
|---|---|---|---|
| 已登入，點擊 ETF | ✅ 已實作 | `EtfThemeScreen.kt:120` | |
...
| 1.2 建立 EtfThemeRepository interface | Domain | ✅ 存在 |
...
| `/review-mr` 完成後 | MR ID + 規格路徑 + review 結果 | Scenario 對照表 + 問題清單 + 品質評分 |
